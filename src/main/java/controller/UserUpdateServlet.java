...
// 5개 수정 기능 URL 통합 매핑
@WebServlet({ "/user/resetName", "/user/resetPassword", "/user/resetPhoneNumber", "/user/resetAddress",
		"/user/resetEmail" })
	...
	private void processUpdate(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			case "/user/resetEmail":
				...
				if (newEmail == null)
					newEmail = (String) requestData.get("newEmail");
			...
			case "/user/resetPassword":
				...
				if (newPw == null)
					newPw = (String) requestData.get("password");
